...
**
** Created: Wed Apr 12 11:14:58 2017
...
const QMetaObject Rectangle::staticMetaObject = {
    { &BaseShape::staticMetaObject, qt_meta_stringdata_Rectangle,
      qt_meta_data_Rectangle, 0 }
};
...
void *Rectangle::qt_metacast(const char *_clname)
{
    ...
    return BaseShape::qt_metacast(_clname);
}

int Rectangle::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = BaseShape::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
